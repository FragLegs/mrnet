...
but have not yet completed the data augmentation or ensembling steps.
...
\end{center}
   \caption{Pre-baseline loss for each diagnosis and series.}
...
\end{center}
   \caption{Pre-baseline AUC for each diagnosis and series.}
\label{fig:mrnet_auc}
\end{figure}
...
MRNet (milestone) & 0.831 - 0.943 & 0.913 - 0.956 & 0.751 - 0.829 \\
\hline
\end{tabular}
\end{center}
