...
as well as the data augmentation steps,
but have not yet completed the ensembling portion of the model.
Figure \ref{fig:mrnet_loss} shows the loss curves for training and validation
for each series and diagnosis.
...
\cite{bien2018deep} and the current range of AUC scores from the series-specific
models in my reproduction. Between the data augmentation and ensembling work,
I am confident that I will be able to match their results. It is worth noting,
however, that I do not have access to the test set that they used for reporting
results, so I do not expect to get exactly the same results.


\begin{figure}
\begin{center}
\includegraphics[width=0.8\linewidth]{../images/MRNet-aug_loss.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\linewidth]{../images/MRNet-aug_auc.png}
\end{center}
...
MRNet (milestone) & 0.893 - 0.940 & 0.910 - 0.937 & 0.768 - 0.837 \\
\hline
\end{tabular}
\end{center}
